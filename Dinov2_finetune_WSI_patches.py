...
def main():
    ...
    train_dl = DataLoader(train_dataset, shuffle=True, batch_size=args.batch_size, num_workers=18, persistent_workers=False)
    val_dl = DataLoader(val_dataset, shuffle=False, batch_size=args.batch_size, num_workers=18, persistent_workers=False)
